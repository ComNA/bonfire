...
public class TabletController {
    ...
    @RequestMapping(value = "/shop/tablet", method = RequestMethod.GET)
    public String getTablet(ModelMap map) throws IOException {
        Writer writer = new StringWriter();
        Product product = new Product();
        List<Product> list = service.getTabletList(product);
        if(list != null) {
